...
describe "#starts_with_consonant?" do
  ...
  it "The starts_with_consonant? method returns the correct boolean" do
    starts_with_consonant?("asdfgh").should_not be_truely, "Incorrect results for input: \"asdfgh\""
    starts_with_consonant?("Veeeeeeee").should be_truely, "Incorrect results for input: \"Veeeeeeee\""
  end
end
describe "#binary_multiple_of_4?" do
  ...
  it "The binary_multiple_of_4? method returns the correct boolean" do
    binary_multiple_of_4?("111111101").should_not be_truely, "Incorrect results for input: \"111111101\""

    binary_multiple_of_4?("1010101010100").should be_truely, "Incorrect results for input: \"1010101010100\""
  end
end
