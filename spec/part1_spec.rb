...
describe "#sum_to_n?" do
  ...
  it "returns the correct value" do
    sum_to_n?([1,2,3,4,5], 5).should be_ truthy
    sum_to_n?([1,2,5,6,7,8], 3).should be_ truthy
    sum_to_n?([100,50,50,2,100,4,5], 100).should be_ truthy
    sum_to_n?([1,2,3,4,5], -3).should be_ falsey
  end
end
